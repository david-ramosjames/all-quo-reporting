...
const FIRM_FIELDS = [
  ...
  { key: 'report_email_to', label: 'Report recipients', type: 'text', group: 'Email',
    help: 'Comma-separated. Receives daily / weekly / monthly reports.' },
  { key: 'missed_calls_email_to', label: 'Missed-call recipients', type: 'text', group: 'Email',
    help: 'Optional. Falls back to the report recipients above.' },
  { key: 'email_from', label: 'From address', type: 'text', group: 'Email',
    help: 'Optional. Falls back to the global EMAIL_FROM.' },
