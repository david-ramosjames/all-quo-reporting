...
const FIRM_FIELDS = [
  ...
  { key: 'monthly_email_to', label: 'Monthly newsletter recipients', type: 'text', group: 'Email',
    help: 'Optional. Falls back to the default recipients.' },
  { key: 'stats_email_to', label: 'Morning recipients (prior-day recap)', type: 'text', group: 'Yesterday Call Stats',
    help: 'Comma-separated email addresses (name@domain.com). Names without an address are ignored. Sent in the morning with yesterday’s full day. Blank = skip this send. Does NOT fall back to the default report recipients.' },
  { key: 'stats_morning_time', label: 'Morning send time', type: 'text', group: 'Yesterday Call Stats', placeholder: '7:30 AM',
    help: 'Local time (America/Chicago unless TIMEZONE is set). Blank = 7:30 AM.' },
  { key: 'stats_missed_goal', label: 'Morning / full-day missed-calls goal', type: 'text', group: 'Yesterday Call Stats', placeholder: '10',
    help: 'Headline count (Missed + Voicemail + Answered by agent + Agent abandoned). Green under this number, red at/above. Used for the prior-day morning send. Blank = 10.' },
  { key: 'stats_midday_email_to', label: '1:00 PM recipients (today so far)', type: 'text', group: 'Yesterday Call Stats',
    help: 'Comma-separated email addresses (name@domain.com). Names without an address are ignored. Sent at 1:00 PM with midnight–1:00 PM today vs the same hours last week. Blank = skip this send. Separate list from the morning send.' },
  { key: 'stats_midday_time', label: 'Midday send time', type: 'text', group: 'Yesterday Call Stats', placeholder: '1:00 PM',
    help: 'Blank = 1:00 PM. Window is midnight through this clock time.' },
  { key: 'stats_missed_goal_midday', label: '1:00 PM missed-calls goal', type: 'text', group: 'Yesterday Call Stats', placeholder: 'same as full-day',
    help: 'Goal for the midday (today so far) send. Set a lower number than the full-day goal. Blank = use the morning / full-day goal.' },
  { key: 'stats_afternoon_email_to', label: '5:00 PM recipients (today so far)', type: 'text', group: 'Yesterday Call Stats',
    help: 'Comma-separated email addresses (name@domain.com). Names without an address are ignored. Sent at 5:00 PM with midnight–5:00 PM today vs the same hours last week. Blank = skip this send. Separate list from the other sends.' },
  { key: 'stats_afternoon_time', label: 'Afternoon send time', type: 'text', group: 'Yesterday Call Stats', placeholder: '5:00 PM',
    help: 'Blank = 5:00 PM. Window is midnight through this clock time.' },
  { key: 'stats_missed_goal_afternoon', label: '5:00 PM missed-calls goal', type: 'text', group: 'Yesterday Call Stats', placeholder: 'same as full-day',
