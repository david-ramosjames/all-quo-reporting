...
const FIRM_FIELDS = [
  ...
  { key: 'stats_email_to', label: 'Morning recipients (prior-day recap)', type: 'text', group: 'Yesterday Call Stats',
    help: 'Comma-separated. Sent in the morning with yesterday’s full day. Blank = skip this send. Does NOT fall back to the default report recipients.' },
  ...
  { key: 'stats_midday_email_to', label: '1:00 PM recipients (today so far)', type: 'text', group: 'Yesterday Call Stats',
    help: 'Comma-separated. Sent at 1:00 PM with midnight–1:00 PM today vs the same hours last week. Blank = skip this send. Separate list from the morning send.' },
  ...
  { key: 'stats_afternoon_email_to', label: '5:00 PM recipients (today so far)', type: 'text', group: 'Yesterday Call Stats',
    help: 'Comma-separated. Sent at 5:00 PM with midnight–5:00 PM today vs the same hours last week. Blank = skip this send. Separate list from the other sends.' },
